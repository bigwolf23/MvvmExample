...
namespace MvvmExmaple.ViewModel
{
    public class UserViewModel
    {
        private IList<User> _UsersList;
        private GetWebData _AllWebData;
        ...
        public UserViewModel()
        {
            ...
            _AllWebData = new GetWebData();

        }

        public GetWebData WebData
        {
            get { return _AllWebData; }
            set { _AllWebData = value; }
        }
